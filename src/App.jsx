  ...
  return (
    <div className="min-h-screen w-full">
      ...
      <main className="w-full">
        ...
        <section id="portfolio" className="py-24 bg-gray-50 w-full">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <section id="team" className="py-24 bg-white w-full">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <section id="contact" className="py-24 bg-gray-50 w-full">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
